...
public class AddCouchettePassangerCarCommand implements CommandMenu {

	private TrainController trainController;
	private PassangerCarBuilder passangerCarBuilder;

	public AddCouchettePassangerCarCommand(TrainController trainController,
	...
	@Override
	public void execute() {
		AbstractPassangerCar car = passangerCarBuilder.BuildCouchette();
