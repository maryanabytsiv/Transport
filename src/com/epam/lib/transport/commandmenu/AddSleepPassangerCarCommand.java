...
public class AddSleepPassangerCarCommand implements CommandMenu {
	
	private TrainController trainController;
	private PassangerCarBuilder passangerCarBuilder;
	
	public AddSleepPassangerCarCommand(TrainController trainController, PassangerCarBuilder passangerCarBuilder) {
	...
	@Override
	public void execute() {
		AbstractPassangerCar car = passangerCarBuilder.BuildSleep();
