...
public class AddCoupePassangerCarCommand implements CommandMenu {
	
	private TrainController trainController;
	private PassangerCarBuilder passangerCarBuilder;

	public AddCoupePassangerCarCommand(TrainController trainController,
	...
	@Override
	public void execute() {
		AbstractPassangerCar car = passangerCarBuilder.BuildCoupe();
